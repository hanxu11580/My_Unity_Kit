...
namespace Hotfix
{
    ...
    {
        [IgnoreDataMember]
        private static readonly ET.Pool<HashSet<Entity>> hashSetPool = new ET.Pool<HashSet<Entity>>();

        [IgnoreDataMember]
        private static readonly ET.Pool<Dictionary<Type, Entity>> dictPool = new ET.Pool<Dictionary<Type, Entity>>();

        [IgnoreDataMember]
        private static readonly ET.Pool<Dictionary<long, Entity>> childrenPool = new ET.Pool<Dictionary<long, Entity>>();
        ...
        public Entity Parent
        {
            ...
            set
            {
                ...
                if (this.parent != null) // 之前有parent
                {
                    ...
                    {
                        ET.Log.Error($"重复设置了Parent: {this.GetType().Name} parent: {this.parent.GetType().Name}");
                        return;
                    }
