...
namespace Hotfix
{
    public sealed class Scene: Entity
    {
        ...
        public Scene(long id, int zone, SceneType sceneType, string name)
        {
            ...
            ET.Log.Info($"scene create: {this.SceneType} {this.Name} {this.Id} {this.InstanceId} {this.Zone}");
        }
        ...
        public override void Dispose()
        {
            ...
            ET.Log.Info($"scene dispose: {this.SceneType} {this.Name} {this.Id} {this.InstanceId} {this.Zone}");
        }
