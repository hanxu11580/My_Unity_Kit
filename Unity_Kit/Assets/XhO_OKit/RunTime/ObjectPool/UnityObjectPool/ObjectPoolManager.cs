...
namespace XhO_OKit
{
    ...
    public sealed class ObjectPoolManager : ManagerBase
    {
        /// <summary>
        /// 单个对象池上限
        /// </summary>
        ...
        public void RegisterSpawnPool(string name, GameObject spawnTem, XhO_OKitAction<GameObject> onSpawn = null, XhO_OKitAction<GameObject> onDespawn = null, int limit = 0)
        {
